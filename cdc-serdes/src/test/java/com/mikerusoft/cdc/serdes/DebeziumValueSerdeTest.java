...
class DebeziumValueSerdeTest {
    ...
    class KeyTests {
        ...
        void whenKeyInSchemaIsIntAndValueIsInt_expectedInt() throws Exception {
            ...
            DebeziumValueSerde<Integer> serde = new DebeziumValueSerde<>(Integer.class, true);
        ...
        void whenKeyInSchemaIsStringAndValueIsInt_expectedInt() throws Exception {
            ...
            DebeziumValueSerde<String> serde = new DebeziumValueSerde<>(String.class, true);
    ...
    class ValueTests {
        ...
        void withPredicateEmptyCheck_whenDeleteEventValueContainsAllFieldsNull_expectedNull() throws Exception {
            ...
            DebeziumValueSerde<Customer> serde = new DebeziumValueSerde<>(Customer.class, false);
